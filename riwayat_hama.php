<?php
session_start();
$title = "Riwayat Hama - Certainty Factor (CF)";
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Riwayat Hama</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">Riwayat Hama</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
            <hr>
            ...
            <div class="row">
                <div class="col-8">
                    ...
                    <table id="example" class="table table-bordered table-hover">
                        ...
                        $i = 1;
                        $counter = 1;
                        $hasil = mysqli_query($conn, "SELECT * FROM hasil_hama ORDER BY id_hasil");
                        ...
                        ?>
                                <tr class="<?= $warna; ?>">
                                    ...
                                    <td align=center>
                                        ...
                                        <a class="btn btn-danger btn-xs hapus_riwayatHama" href="riwayat_hapushama.php?id=<?= $r[0]; ?>"><i class="fas fa-trash"></i> Hapus</a> &nbsp;
                                    </td>
                                </tr>
                                <?php $i++; ?>
                                <?php $counter++; ?>
