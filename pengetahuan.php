...
$title = "Pengetahuan - Certainty Factor (CF)";
                    ...
                    <div class="col-12">
                        ...
                        <div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="pengetahuan/tambah.php" method="post">
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="kode_gejala" id="kode_gejala">
                                                    ...
                                                    ?>
                                                        <option value="<?= $gejala["kode_gejala"]; ?>"><?= substr($gejala["nama_gejala"], 0, 50); ?>......</option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            <div class="form-group">
                        ...
                        <div class="col-12">
                            <table class="table table-bordered table-hover" id="example" cellspacing="0">
                                ...
                                <?php
                                $i = 1;
                                $sql = mysqli_query($conn, "SELECT * FROM basis_pengetahuan
                                                            INNER JOIN penyakit
                                                            ON basis_pengetahuan.kode_penyakit = penyakit.kode_penyakit
                                                            INNER JOIN gejala
                                                            ON basis_pengetahuan.kode_gejala = gejala.kode_gejala");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger btn-sm hapus_pengetahuan" href="pengetahuan/hapus.php?id=<?= $row["kode_pengetahuan"]; ?>"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                                            ...
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" name="kode_penyakit" id="kode_penyakit">
                                                                        ...
                                                                        while ($penyakit = mysqli_fetch_assoc($query)) {
                                                                        ?>
                                                                            <option value="<?= $penyakit["kode_penyakit"]; ?>" <?php if ($row["kode_penyakit"] == $penyakit["kode_penyakit"]) echo "selected" ?>><?= $penyakit["nama_penyakit"]; ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" name="kode_gejala" id="kode_gejala">
                                                                        ...
                                                                        while ($gejala = mysqli_fetch_assoc($query)) {
                                                                        ?>
                                                                            <option value="<?= $gejala["kode_gejala"]; ?>" <?php if ($row["kode_gejala"] == $gejala["kode_gejala"]) echo "selected" ?>><?= $gejala["nama_gejala"]; ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                                </div>
                                                                <div class="form-group">
